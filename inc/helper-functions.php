...
function openagenda_icons() {
	...
	$icons = array(
		'calendar'   => '<span class="oa-icon oa-icon-calendar fa fa-calendar"></span>',
		'clock'      => '<span class="oa-icon oa-icon-clock fa fa-clock"></span>',
		'download'   => '<span class="oa-icon oa-icon-download fa fa-download"></span>',
		'email'      => '<span class="oa-icon oa-icon-envelope fa fa-envelope"></span>',
		'facebook'   => '<span class="oa-icon oa-icon-facebook fa fa-facebook"></span>',
		'home'       => '<span class="oa-icon oa-icon-home fa fa-home"></span>',
		'link'       => '<span class="oa-icon oa-icon-link fa fa-link"></span>',
		'linkedin'   => '<span class="oa-icon oa-icon-linkedin fa fa-linkedin"></span>',
		'location'   => '<span class="oa-icon oa-icon-map-marker-alt fa fa-map-marker-alt"></span>',
		'next'       => '<span class="oa-icon oa-icon-chevron-right fa fa-chevron-right"></span>',
		'phone'      => '<span class="oa-icon oa-icon-phone fa fa-phone"></span>',
		'pinned'     => '<span class="oa-icon oa-icon-thumbtack fa fa-thumbtack"></span>',
		'previous'   => '<span class="oa-icon oa-icon-chevron-left fa fa-chevron-left"></span>',
		'refresh'    => '<span class="oa-icon oa-icon-sync fa fa-sync"></span>',
		'check'      => '<span class="oa-icon oa-icon-check fa fa-check"></span>',
		'square-check' => '<span class="oa-icon oa-icon-square-check fa fa-square-check"></span>',
		'star'       => '<span class="oa-icon oa-icon-star fas fa-star"></span>',
		'star-empty' => '<span class="oa-icon oa-icon-star far fa-star"></span>',
		'share'      => '<span class="oa-icon oa-icon-share fas fa-share-alt"></span>',
		'share-nodes' => '<span class="oa-icon oa-icon-share-nodes fa fa-share-nodes"></span>',
		'ticket'     => '<span class="oa-icon oa-icon-ticket fa fa-ticket"></span>',
		'twitter'    => '<span class="oa-icon oa-icon-twitter fa fa-twitter"></span>',
		'website'    => '<span class="oa-icon oa-icon-globe fa fa-globe"></span>',
		'x'          => '<span class="oa-icon oa-icon-twitter fa fa-twitter"></span>',
	);
