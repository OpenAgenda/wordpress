...
/******/ 	return __webpack_require__(__webpack_require__.s = "IVro");
/******/ })
/************************************************************************/
/******/ ({
...
var _setTimeout2 = _interopRequireDefault(__webpack_require__("yC+K"));

var _style = _interopRequireDefault(__webpack_require__("aDL2"));
...
var UID = 0,
    ...
    baseConfig = __webpack_require__("Yhph"),
    template = __webpack_require__("OjRg"),
...
var widget = function widget(elem, options) {
  ...
  (function () {
    ...
    _createElement(elem.hasAttribute(config.searchLabelAttribute) ? {
      search: elem.getAttribute(config.searchLabelAttribute)
    } : config.labels[lang]);
  ...
  function _onInput(e) {
    ...
    if (e.keyCode == 13) {
      ...
      waiting = (0, _setTimeout2.default)(_processInput, config.delay);
    }
  }
...
module.exports = function anonymous(locals, escapeFn, include, rethrow) {
    ...
    try {
        ...
        with (locals || {}) {
            __append('<label for="geosearch">');
            __append(escapeFn(labels.search));
            __append('</label>\n<input title="');
            __line = 2;
            __append(escapeFn(labels.search));
            __append('" type="text" placeholder="');
            __append(escapeFn(labels.search));
            __append('" name="geosearch">\n');
            __line = 3;
        }
        return __output;
    } catch (e) {
