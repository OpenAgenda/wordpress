...
/******/ 	return __webpack_require__(__webpack_require__.s = "pfkW");
/******/ })
/************************************************************************/
/******/ ({
...
exports.humanize = __webpack_require__("5qnx");
...
exports = module.exports = __webpack_require__("N2ji");
exports.log = log;
exports.formatArgs = formatArgs;
exports.save = save;
exports.load = load;
...
var debug = __webpack_require__( "NfCe" ),
...
function parser( struct ) {
  ...
  function render( data ) {
    ...
    if ( typeof template === 'undefined' ) throw new Error( 'template is undefined' );

    var rendered = template, cleanValue;

    for( var i in clean ) {

      // process the children blocks
      if ( struct.children && _isArray( clean[ i ] ) ) {
      ...
      if ( templateAttributeBlocks[ i ] !== undefined ) {
        ...
        // attribute blocks are conditional, if the data is non-existant, they are removed
        if ( !clean[ i ] ) {
      ...
      if ( templateAttributes[ i ] !== undefined ) {
        ...
        cleanValue = _isArray( clean[ i ] ) ? clean[ i ].join( ', ' ) : clean[ i ] || '';

        rendered = rendered.replace( new RegExp( '{' + templateAttributes[ i ] + '}', 'g'), cleanValue );
...
/**
 * get value matching child objects
 */
function _navigateObj( data, key ) {
  ...
  while ( keyParts.length ) {
    ...
    if ( value === null || typeof value[ currentKey ] === 'undefined' ) {
...
function _renderChild( key, arr, children, rendered ) {
  ...
  arr.forEach( function( childData ) {
    ...
    if ( child.itemName ) {
      ...
      data[ child.mapTo ] = childData;

    }

    childRender += child.parser.render( data );
...
function _mergeExpected( data, tplAttributes, children ) {
  ...
  for( var i in tplAttributes ) {
    ...
    } else if ( typeof _navigateObj( data, i ) !== 'undefined' ) {

      clean[ i ] = _navigateObj( data, i );
  ...
  if ( children ) children.forEach( function( child ) {
    ...
    if ( typeof _navigateObj( data, child.mapTo ) !== 'undefined' ) {

      clean[ child.mapTo ] = _navigateObj( data, child.mapTo );
...
module.exports = JSON.parse("{\"attributes\":[{\"name\":\"TotalEvents\",\"mapTo\":\"total\"}],\"children\":[{\"name\":\"Events\",\"mapTo\":\"events\",\"attributes\":[{\"name\":\"Title\",\"mapTo\":\"title\"},{\"name\":\"Slug\",\"mapTo\":\"slug\"},{\"name\":\"Description\",\"mapTo\":\"description\"},{\"name\":\"Link\",\"mapTo\":\"link\"},{\"name\":\"Uid\",\"mapTo\":\"uid\"},{\"name\":\"ImageUrl\",\"mapTo\":\"image\"},{\"name\":\"ThumbnailUrl\",\"mapTo\":\"thumbnail\"},{\"name\":\"LocationName\",\"mapTo\":\"locationName\"},{\"name\":\"City\",\"mapTo\":\"city\"},{\"name\":\"DateRange\",\"mapTo\":\"range\"},{\"name\":\"PricingInfo\",\"mapTo\":\"pricingInfo\"},{\"name\":\"TicketUrl\",\"mapTo\":\"registrationUrl\"}],\"children\":[{\"mapTo\":\"tags\",\"name\":\"Tags\",\"attributes\":[{\"mapTo\":\"id\",\"name\":\"TagId\"},{\"mapTo\":\"slug\",\"name\":\"TagSlug\"},{\"mapTo\":\"label\",\"name\":\"Tag\"}]},{\"name\":\"TagGroups\",\"mapTo\":\"tagGroups\",\"attributes\":[{\"name\":\"Name\",\"mapTo\":\"name\"},{\"name\":\"GroupName\",\"mapTo\":\"name\"},{\"name\":\"GroupSlug\",\"mapTo\":\"slug\"}],\"children\":[{\"name\":\"Tags\",\"mapTo\":\"tags\",\"attributes\":[{\"name\":\"Tag\",\"mapTo\":\"label\"},{\"name\":\"TagLink\",\"mapTo\":\"link\"},{\"name\":\"TagSlug\",\"mapTo\":\"slug\"}]}]},{\"mapTo\":\"registration\",\"name\":\"Registration\",\"attributes\":[{\"name\":\"Prefix\",\"mapTo\":\"prefix\"},{\"name\":\"Type\",\"mapTo\":\"type\"},{\"name\":\"Value\",\"mapTo\":\"value\"}]}]}]}");
...
var $ = __webpack_require__("ax0f");
var createHTML = __webpack_require__("gIHd");
var forcedStringHTMLMethod = __webpack_require__("sHxg");
...
__webpack_require__("hBvt");

var _parseInt2 = _interopRequireDefault(__webpack_require__("I2Za"));

var _forEach = _interopRequireDefault(__webpack_require__("i6Tr"));

var _indexOf = _interopRequireDefault(__webpack_require__("0wSO"));

var _slice = _interopRequireDefault(__webpack_require__("Jshs"));

var _map = _interopRequireDefault(__webpack_require__("X54e"));

var _preview = _interopRequireDefault(__webpack_require__("/Yd3"));

var _style = _interopRequireDefault(__webpack_require__("tQL1"));

var domain = __webpack_require__("HovQ");

var parser = __webpack_require__("R4jE"),
    cn = __webpack_require__("ycY6"),
    config = __webpack_require__("jSGr"),
    UID = 0,
    LANG = 1,
    env = window.env ? window.env : 'production',
    tplMap = __webpack_require__("eVrQ"),
    remote = __webpack_require__("tPtL"),
  ...
  // required
  link: false,
  // optional. link to agenda page
  eventPart: false,
  // required. bit to add to link to open event
  lang: 'fr',
  useStyle: true,
  count: config.count
};
...
function widget(elem, options) {
  ...
  _fetch(params.json, function (err, data) {
    ...
    var wTpl = _extractTemplate(_preview.default, elem),
    ...
    elem.innerHTML = '';
    elem.insertAdjacentElement('afterbegin', _render(wTpl, {
      events: events,
      total: data.total
    }));

    if (window.oa && window.oa.onWidgetReady) {
      window.oa.onWidgetReady('preview', {
        uid: params.uid
      });
    }
  });
...
function _clean(events, options) {
  ...
  return (0, _map.default)(_context = (0, _slice.default)(events).call(events, 0, options.count)).call(_context, function (event) {
...
function _extractTemplate(defaultTemplate, elem) {
  ...
  var startIndex = (0, _indexOf.default)(_context2 = elem.innerHTML).call(_context2, '<!--'),
      endIndex = (0, _indexOf.default)(_context3 = elem.innerHTML).call(_context3, '-->');

  if (startIndex == -1 || endIndex == -1) {
    return defaultTemplate;
  }

  return elem.innerHTML.substr(startIndex + '<!--'.length, endIndex - startIndex - '<!--'.length).replace('src="/{', 'src="{').replace('href="/{', 'href="{');
}
...
function _flattenMultilinguals(event, e, lang) {
  (0, _forEach.default)(cn).call(cn, ['title', 'description', 'longDescription', 'range'], function (field) {
    var l = false;
...
function _filterByAttr(obj, arr) {
  var newObj = {};
  (0, _forEach.default)(cn).call(cn, arr, function (name) {
    if (obj[name] !== undefined) newObj[name] = obj[name];
  });
  return newObj;
}
...
function _init() {
  var res = config.res[env] ? config.res[env] : config.res.all,
    ...
    var arr = elem.getAttribute(config.attributes.config).split('|'),
        ...
        count = elem.hasAttribute(config.attributes.count) ? (0, _parseInt2.default)(elem.getAttribute(config.attributes.count), 10) : 3,
    ...
    widget(elem, {
      ...
      lang: lang,
      json: json,
      eventPart: (0, _indexOf.default)(link).call(link, domain) !== -1 ? res.eventPart : res.embedEventPart,
      useStyle: !elem.hasAttribute(config.attributes.noDefaultStyle),
      count: count
    });
  };

  (0, _forEach.default)(cn).call(cn, cn.els(config.selector), _process);
  if (found) return;
  (0, _forEach.default)(cn).call(cn, document.querySelectorAll(config.backupSelector), function (elem) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".oa-preview ul {\n\n  list-style-type: none;\n  padding: 0;\n\n}\n\n.oa-preview li {\n\n  padding: 0 0 1em;\n\n}\n\n.oa-preview a {\n\n  text-decoration: inherit;\n\n}\n\n.oa-preview span {\n\n  display: block;\n\n}\n\n.oa-preview .oa-title {\n\n  font-weight: bold;\n\n}");
