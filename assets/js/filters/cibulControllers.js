...
/******/ 	return __webpack_require__(__webpack_require__.s = "/5jF");
/******/ })
/************************************************************************/
/******/ ({
...
if (!window.cibul) {
  var debug = __webpack_require__("NOtv"),
      ...
      controller = __webpack_require__("P1BI");
...
module.exports = __webpack_require__("RLo2");
...
var $ = __webpack_require__("n9AK");
var parseFloatImplementation = __webpack_require__("aZ/c");
...
var sameValue = __webpack_require__("FNAH");
...
var _parseFloat = __webpack_require__("CSyZ");
...
var base64 = __webpack_require__("c2tx");
...
var remote = __webpack_require__("tPtL");

var filters = __webpack_require__("kuGI");

var geoLib = __webpack_require__("bEm/");

var controlDataFetch = __webpack_require__("UVqe");
...
module.exports = function (uid) {
  ...
  function getWidget(name) {
    ...
    _forEachInstanceProperty(cn).call(cn, widgets, function (widget) {
      if (widget.name == name) {
        widgetParams = widget;
      }
    });
  ...
  function update(originWidget, updatedParams, isExclusive) {
    ...
    log('updating with %s (%sexclusive) from %s', _JSON$stringify(updatedParams), isExclusive ? 'is ' : 'not ', originWidget);
  ...
  function _initControlData(data) {
    ...
    _forEachInstanceProperty(cn).call(cn, data.l, function (l) {
      locations[l.u] = {
        lt: l.lt,
        lg: l.lg
      };
    ...
    _forEachInstanceProperty(cn).call(cn, data.ev, function (e) {
      if (e.l) {
    ...
    for (var k in data) {
      if (data[k] !== null) {
        ...
        if (_indexOfInstanceProperty(_context2 = ['neLat', 'neLng', 'swLat', 'swLng']).call(_context2, k) !== -1) {
          cleanData[k] = _parseFloat(data[k]);
        } else if (k == 'tags') {
...
module.exports = function (ctlData, initValues, cb) {
  ...
  requestTimeout = _setTimeout(function () {
...
function _extractClosest(locations, coords, count, cb) {
  ...
  for (var i = locations.length - 1; i >= 0; i--) {
    ...
    if (typeof processed[currentLocation.u] == 'undefined') {
      currentDistance = _parseInt(_distance(currentLocation.lt, currentLocation.lg, coords[0], coords[1]), 10);
...
function what(item, reqParams, whatUids) {
  if (reqParams.what) {
    if (!whatUids || _indexOfInstanceProperty(whatUids).call(whatUids, _parseInt(item.u, 10)) == -1) {
      return false;
    }
  }
...
function locations(item, reqParams) {
  if (reqParams.location) {
    return _parseInt(reqParams.location, 10) == item.l;
  ...
  if (reqParams.neLat && reqParams.neLng && reqParams.swLat && reqParams.swLng) {
    var ne = [_parseFloat(reqParams.neLat), _parseFloat(reqParams.neLng)],
        sw = [_parseFloat(reqParams.swLat), _parseFloat(reqParams.swLng)];
