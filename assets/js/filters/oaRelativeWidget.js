...
/******/ 	return __webpack_require__(__webpack_require__.s = "wA0l");
/******/ })
/************************************************************************/
/******/ ({
...
module.exports = JSON.parse("{\"attributes\":[{\"name\":\"Today\",\"mapTo\":\"today\"},{\"name\":\"Tomorrow\",\"mapTo\":\"tomorrow\"},{\"name\":\"ThisWeekend\",\"mapTo\":\"thisWeekend\"},{\"name\":\"ThisWeek\",\"mapTo\":\"thisWeek\"},{\"name\":\"ThisMonth\",\"mapTo\":\"thisMonth\"}]}");
...
/* harmony default export */ __webpack_exports__["default"] = ("<ul>\n  <li><a href=\"#\" class=\"js_today\">{Today}</a></li>\n  <li><a href=\"#\" class=\"js_tomorrow\">{Tomorrow}</a></li>\n  <li><a href=\"#\" class=\"js_this_weekend\">{ThisWeekend}</a></li>\n  <li><a href=\"#\" class=\"js_this_week\">{ThisWeek}</a></li>\n  <li><a href=\"#\" class=\"js_this_month\">{ThisMonth}</a></li>\n</ul>");
...
var _Object$keys = __webpack_require__("cUqe");
...
module.exports = function (labels, lang, fallback) {
  ...
  for (var f in labels) {
    ...
    if (typeof flat[f] === 'undefined' && fallback) {
      possibleLangs = _Object$keys(labels[f]);
...
var _filter = _interopRequireDefault(__webpack_require__("oHrz"));

var _forEach = _interopRequireDefault(__webpack_require__("i6Tr"));

var _relative = _interopRequireDefault(__webpack_require__("OfmH"));

var _ = {
  head: __webpack_require__("odjl")
};

var debug = __webpack_require__("NOtv");

var flattenLabels = __webpack_require__("P2Yn");

var labels = __webpack_require__("7nNq");

var Parser = __webpack_require__("R4jE");

var utils = __webpack_require__("QkVY");

var wLib = __webpack_require__("NXqE");

var cn = __webpack_require__("ycY6");

var map = __webpack_require__("DHgg");
...
function widget(elem, options) {
  ...
  var lang = options.anchorConfig[LANG];
  var widgetLabels = flattenLabels(labels, lang);
  var log = debug('relative widget ' + uid);
  var enabled = false;
  log('initing');
  var controller = options.register(wLib.interface('relative', uid, {
    enable: enable,
    disable: disable
  }));

  _renderAndBehave(function (selected) {
    if (!enabled) return;
  ...
  controller.getControlData(function (data) {
    ...
    controller.onWidgetReady('relative', {
      uid: uid
    });
    if (onReady) onReady();
  });
  ...
  function _renderAndBehave(onClick) {
    var parser = Parser(map);
    parser.load(_relative.default);
    elem.innerHTML = parser.render(widgetLabels);
    (0, _forEach.default)(cn).call(cn, cn.els(elem, 'a'), function (link) {
      cn.addEvent(link, 'click', function (e) {
        var _context;

        cn.preventDefault(e);

        var code = _.head((0, _filter.default)(_context = link.className.split(' ')).call(_context, function (cls) {
          return cls.substr(0, 3) === 'js_';
        }));
