...
/******/ 	return __webpack_require__(__webpack_require__.s = "91TG");
/******/ })
/************************************************************************/
/******/ ({
...
__webpack_require__("XygZ");

var _parseFloat = __webpack_require__("CSyZ");

var _setTimeout = __webpack_require__("yC+K");

var _mapInstanceProperty = __webpack_require__("X54e");

if (typeof L === 'undefined') {
  __webpack_require__("4R65");
}

var maps = __webpack_require__("ACIO"),
    utils = __webpack_require__("QkVY");

__webpack_require__("lese");
...
maps.register('osm', function () {
  ...
  return {
    ...
    createMap: function createMap(mapElt, options) {
      ...
      var map = _mapInstanceProperty(L).call(L, mapElt, {
    ...
    createBounds: function createBounds(pos, options) {
      ...
      return new L.LatLngBounds(new L.LatLng(_parseFloat(pos[0]) - options.padding, _parseFloat(pos[1]) - options.padding), new L.LatLng(_parseFloat(pos[0]) + options.padding, _parseFloat(pos[1]) + options.padding));
    },
    extendBounds: function extendBounds(bounds, pos, options) {
      var params = utils.extend({
        padding: 0.001
      }, typeof options === 'undefined' ? options : {}); // extend to the north-east

      bounds.extend(new L.LatLng(_parseFloat(pos[0]) + params.padding, _parseFloat(pos[1]) + params.padding)); // extend to the south-west

      bounds.extend(new L.LatLng(_parseFloat(pos[0]) - params.padding, _parseFloat(pos[1]) - params.padding));
    },
...
module.exports = function () {
  ...
  function add(reqParams, bounds) {
    var newItem = {
      k: _JSON$stringify(_clean(reqParams)),
      b: bounds
    };
  ...
  function _clean(obj) {
    ...
    for (var k in obj) {
      clean[k] = !isNaN(obj[k]) ? _parseFloat(obj[k]) : obj[k];
    }
  ...
  function _match(reqParams, invIndex) {
    ...
    return history[history.length + invIndex].k == _JSON$stringify(reqParams);
  }
...
var _splice = _interopRequireDefault(__webpack_require__("L0Na"));

var _stringify = _interopRequireDefault(__webpack_require__("AP/O"));

var _forEach = _interopRequireDefault(__webpack_require__("i6Tr"));

var _parseFloat2 = _interopRequireDefault(__webpack_require__("CSyZ"));
...
var _style = _interopRequireDefault(__webpack_require__("C2Me"));
...
var UID = 0,
    LANG = 1,
    du = __webpack_require__("aDtO"),
    utils = __webpack_require__("QkVY"),
    remote = __webpack_require__("tPtL"),
    wLib = __webpack_require__("NXqE"),
    debug = __webpack_require__("NOtv"),
    baseConfig = __webpack_require__("ZSyb"),
    history = __webpack_require__("8hNt"),
    mapLib = __webpack_require__("0DuY"),
    utils = __webpack_require__("QkVY"),
    templates = {
  main: __webpack_require__("F783"),
  popup: __webpack_require__("y3s7")
},
...
if ((0, _indexOf.default)(_context = ['tpl', 'development']).call(_context, env) !== -1) debug.enable('*');
...
function widget(elem, options) {
  ...
  return function () {
    ...
    controller.getControlData(function (data) {
      ...
      if (!data.ebd || (0, _map.default)(data.ebd.dcss)) styler(_style.default);
      if (!m) _initMapLib(data.ebd && data.ebd.mt ? data.ebd.mt : config.tiles);

      _initLocations(data);

      _initIcons(data); // base bounds has been defined if config is set in
      // widget attributes
  ...
  function _getMapInitAttributes() {
    ...
    if (coords.length == 3) {
      zoom = (0, _parseInt2.default)(coords.pop(), 10);
    }

    return {
      center: (0, _map.default)(coords).call(coords, function (c) {
        return (0, _parseFloat2.default)(c);
      }),
      zoom: zoom,
      tiles: tiles
    };
  ...
  function _nonMapQueryChange(reqParams) {
    ...
    (0, _forEach.default)(utils).call(utils, keys, function (k) {
      var _context2;

      if ((0, _indexOf.default)(_context2 = ['neLat', 'neLng', 'swLat', 'swLng', 'location']).call(_context2, k) == -1) {
        if ((0, _stringify.default)(reqParams[k]) !== (0, _stringify.default)(current[k])) {
          change = true;
        }
      }
    });
  ...
  function enable(reqParams) {
    ...
    _updateBounds(bounds, function () {
      ...
      if (selectedEvent && activeLocations.length) {
        ...
        popupLocation = selectedLocation = locations[(0, _parseInt2.default)(reqParams.location, 10)];
      }
  ...
  function _openPopup(l) {
    _fetchLocationInfo(l, function (err, location) {
      ...
      popup = m.createPopup(map, templates.popup(popupData), {
        marker: popupMarker
      });
    });
  }
  ...
  function include(eventItem, reqParams) {
    if ((0, _indexOf.default)(activeLocations).call(activeLocations, eventItem.l) !== -1) return;
  ...
  function _setOnMarkerClick(location) {
    m.setOnMarkerClick(location.marker, function () {
      ...
      if (!selectedLocation && (0, _indexOf.default)(activeLocations).call(activeLocations, location.uid) == -1) {
      ...
      if ((0, _indexOf.default)(passedLocations).call(passedLocations, location.uid) !== -1) {
  ...
  function _refresh(resetCluster) {
    ...
    (0, _forEach.default)(activeLocations).call(activeLocations, function (l) {
  ...
  function _addClusterLayers(clusterGroup, markers) {
    var extract = (0, _splice.default)(markers).call(markers, 0, 4000);
    ...
    if (markers.length) (0, _setTimeout2.default)(function () {
      _addClusterLayers(clusterGroup, markers);
    }, 500);
  }
  ...
  function _refreshMarker(location) {
    var active = enabled && (0, _indexOf.default)(activeLocations).call(activeLocations, location.uid) !== -1;
    m.setMarkerIcon(location.marker, config.icons[active ? 'active' : 'inactive']);
    m.setMarkerZIndex(location.marker, active ? 1000 : -1000); // for count display of marker cluster
  ...
  function _initLocations(data) {
    (0, _forEach.default)(utils).call(utils, data.ev, function (ev) {
      if (!ev.l) return;
  ...
  function _defineBaseBounds(data) {
    ...
    if (mode === 'manual' && data.ebd && typeof data.ebd.mc === 'string') {
      var embedBounds = data.ebd.mc.split('|');
  ...
  function _createMap(options, cb) {
    ...
    m.createMap(du.el(elem, 'div'), {
      center: mapParams.center,
      zoom: mapParams.zoom,
      onReady: function onReady(newMap) {
        map = newMap;
        log('created map');
        if (cb) cb();
      }
  ...
  function _selectBounds(bounds, updateMap) {
    ...
    _update(utils.extend({
      location: null
    }, _getBoundParams(bounds)));
  ...
  function _updateBounds(bounds, cb) {
    ...
    _freezeAuto(); // the leaflet api pretends things are synchronous. They are not.


    (0, _setTimeout2.default)(function () {
      // fit bounds does not ignore zoom extremes
      if (bounds) _fitBounds(bounds); // takes a while for map to adjust
  ...
  function _setMapToBaseBounds() {
    log('setting map to base bounds: %s', (0, _stringify.default)(baseBounds));
  ...
  function _getNeighborBounds(location) {
    ...
    for (var l in locations) {
      // is this a neighbor?
      if ((0, _parseInt2.default)(l, 10) !== location.uid && _distance(locations[l].coords[0], locations[l].coords[1], location.coords[0], location.coords[1]) < distanceThreshold) {
        nCount++;
...
function _isIn(l, reqParams) {
  if (reqParams.neLat && reqParams.neLng && reqParams.swLat && reqParams.swLng) {
    var ne = [(0, _parseFloat2.default)(reqParams.neLat), (0, _parseFloat2.default)(reqParams.neLng)],
        sw = [(0, _parseFloat2.default)(reqParams.swLat), (0, _parseFloat2.default)(reqParams.swLng)],
        lt = (0, _parseFloat2.default)(l.coords[0]),
        lg = (0, _parseFloat2.default)(l.coords[1]);
...
module.exports = function anonymous(locals, escapeFn, include, rethrow) {
    ...
    try {
        ...
        with (locals || {}) {
            __append('<div class="map-canvas"></div>\n<div class="map-sync js_map_sync">\n  <label>');
            __line = 3;
            __append(escapeFn(labels.mapSync));
            __append('</label>\n  <input class="js_sync_checkbox" type="checkbox"/>\n</div>');
            __line = 5;
        }
        return __output;
...
var _defineProperty = __webpack_require__("iFED");

var _objectSpread = __webpack_require__("5XPn");
...
var labels = __webpack_require__("eRLm");
...
module.exports = {
  ...
  zooming: false,
  labels: _reduceInstanceProperty(_context = _Object$keys(labels.mapSync)).call(_context, function (byLang, lang) {
    var _context2;

    return _objectSpread(_objectSpread({}, byLang), {}, _defineProperty({}, lang, _reduceInstanceProperty(_context2 = _Object$keys(labels)).call(_context2, function (byLabel, label) {
      return _objectSpread(_objectSpread({}, byLabel), {}, _defineProperty({}, label, labels[label][lang]));
    }, {})));
  }, {}),
  selectors: {
...
module.exports = {
  "mapSync": {
    "it": "ricerca quando muovo la carta",
...
module.exports = function anonymous(locals, escapeFn, include, rethrow) {
    ...
    try {
        ...
        with (locals || {}) {
            __append('<div class="map-location">\n');
            __line = 2;
            if (typeof count !== "undefined") {
                __append('\n    <span class="count">\n      <span>');
                __line = 4;
                ...
                __append("</span>\n      <label> ");
                __line = 5;
                __append(escapeFn(count == 1 ? labels.events.replace("s", "") : labels.events));
                __append("</label>\n    </span>\n");
                __line = 7;
            }
            __append("\n");
            ...
            __line = 16;
            if (postalCode) {
                __append('<span class="map-postalcode">');
                __append(escapeFn(postalCode));
                __append("</span>");
            }
            __append("\n    ");
            __line = 17;
            if (city) {
                __append('<span class="map-city">');
            ...
            __line = 18;
            if (department) {
                __append('<span class="map-department">');
                __append(escapeFn(department));
                __append("</span>");
            }
            __append("\n    ");
            __line = 19;
            if (region) {
                __append('<span class="map-region">');
                __append(escapeFn(region));
                __append("</span>");
            }
            __append("\n  </span>\n</div>");
            __line = 21;
